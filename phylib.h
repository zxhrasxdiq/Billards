...
double squareIt(double x);// helper
...
/***
void test_phylib_copy_object(void);

void test_phylib_add_object(void);

void test_phylib_free_object(void);

void test_phylib_sub(void);

void test_phylib_length(void);

void test_phylib_dot_product(void);

void test_phylib_distance(void);

void test_phylib_roll(void);

void test_phylib_stopped(void);

void test_phylib_bounce(void);
